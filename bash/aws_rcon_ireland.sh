...
#load config
source /data/home/ec2-user/transnet/configs/ireland-and-northern-ireland.conf
...
python -m cProfile -o cprofile_out.stats Transnet.py -p "../data/$destdir/pfile.poly" -H $host -P $port -D $dname -U $duser -X $pass -d $destdir -V $vlevels $trans_args | tee "../logs/$destdir/transnet.log"
