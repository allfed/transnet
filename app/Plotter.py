...
class Plotter:
	...
	def __init__(self, voltage_levels):
		...
		#updated to reflect proper syntax after matplotlib version 2.2
	...
	def plot_topology(self, circuits, equipments_multipoint, partition_by_station_dict, cities, destdir):
		...
		for circuit in circuits:
			...
			for line in circuit.members[1:-1]:
				...
				# plt.show()
				if(line.voltage.split(';')[0] not in self.color_dict.keys()):
					if(len(line.voltage.split(';'))<2): #this occurs very rarely
						continue         		
